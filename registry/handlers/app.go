...
func NewApp(ctx context.Context, config *configuration.Configuration) *App {
	...
	app.register(v2.RouteNameBase2, func(ctx *Context, r *http.Request) http.Handler {
		return http.HandlerFunc(app.imageList) //imageList
	})
...
func (app *App) nameRequired(r *http.Request) bool {
	...
	return routeName != v2.RouteNameBase2 && routeName != v2.RouteNameBase && routeName != v2.RouteNameCatalog
}

// apiBase implements a simple yes-man for doing overall checks against the
// api. This can support auth roundtrips to support docker login.
func apiBase(w http.ResponseWriter, r *http.Request) {
	const emptyJSON = "{\"key\":\"val\"}"
