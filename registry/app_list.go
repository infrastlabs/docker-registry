...
var (
	...
	apis = flag.String("api2", "https://localhost:8143", "api address")
	user = flag.String("user2", "admin", "registry user")
	pass = flag.String("pass2", "xxx", "registry pass")
	size = flag.Bool("size2", false, "registry size") //or: req's param
